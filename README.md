# Vault Business v2.0.2

Vault Business is a local-first desktop app for organizing protected operational connection data.

## Download

- Vault.Business_2.0.2_x64-setup.exe
...
- Vault.Business_2.0.2_x64-setup.exe.sig
...
## Changes included from v1.5.9 to v2.0.2
...
1. Download `Vault.Business_2.0.2_x64-setup.exe`.
2. Run the installer.
